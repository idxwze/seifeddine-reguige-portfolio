...
export function ContactSection() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(82,225,255,0.12),transparent_0_34%),linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0))]" />
      <div className="relative mx-auto max-w-3xl space-y-8">
        <div className="space-y-3">
          <p className="section-kicker">Reach Out</p>
          <h2 className="section-title mx-auto max-w-[10ch]">Build Something Exceptional</h2>
        </div>

        <p className="mx-auto max-w-2xl text-sm leading-7 text-muted-foreground sm:text-base">
          Open to software opportunities across backend systems, data work, and machine learning. The fastest way to reach me is by email or LinkedIn.
        </p>
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Button asChild size="icon" variant="outline" className="h-12 w-12 rounded-2xl border-white/10 bg-white/[0.03] hover:bg-white/[0.05]">
